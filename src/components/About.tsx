...
export function About() {
  ...
  return (
    <section id="about" className="relative overflow-hidden border-y border-[#2b2b31] bg-[#18181a] pb-24">
      <BackgroundDecor variant="about" />
      <motion.div
        ref={sinceRef}
        className="relative h-[300px] overflow-hidden border-b border-[#24242a] px-5 sm:px-10 md:h-[360px] md:px-16 lg:px-20 xl:h-[410px]"
        initial={{ opacity: 0 }}
      ...
      <div className="relative px-5 sm:px-10 md:px-16 lg:px-20">
        <p className="editor-comment mb-5 pt-10 text-sm">{t.about.comment}</p>

        <motion.div
          className="grid gap-10 xl:grid-cols-[minmax(0,1fr)_270px]"
        ...
        >
          <div>
            ...
            <div className="mt-9 grid max-w-5xl gap-10 lg:grid-cols-[360px_minmax(0,1fr)]">
              <div className="space-y-7 text-[16px] font-medium leading-7 text-[#bdbdbd]">
                {t.about.body.map((paragraph) => (
                  <p key={paragraph}>{paragraph}</p>
                ))}
              </div>

              <p className="max-w-[460px] border-l border-[#34343a] pl-5 text-[16px] font-medium leading-7 text-[#bdbdbd]">
          ...
          <motion.aside
            className="self-start overflow-hidden border border-[#2b2b31] bg-[#151518] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]"
          ...
          >
            ...
            />
            <div className="border-t border-[#2b2b31] p-7 text-center">
              ...
              <a
                ...
                download
                className="mx-auto grid max-w-[180px] grid-cols-[1fr_42px] border border-[#34343a] bg-[#111113] text-sm font-bold text-[#f4f4f4] transition hover:border-[#d8d175] hover:text-[#d8d175]"
              >
